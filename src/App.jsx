...
const RELEASE_NOTES = [
    {
        ...
        desc: "Introduction du Journal de Bord interactif.",
        changes: [
            { icon: Undo2, text: "Annulation : Vous pouvez désormais ouvrir l'historique (via l'icône en haut à gauche) et supprimer une transaction. L'argent sera automatiquement remboursé sur votre solde." }
        ]
    }
];
